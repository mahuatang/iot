...
public class I18nService {
	...
	public String getMessage(String code) {
		...
		String result = commonMessage(code, null);
		return result;
	}
	...
	public String getMessage(String code, Object[] objects) {
		...
		String result = commonMessage(code, objects);
		return result;
	}

	private String commonMessage(String code, Object[] objects) {
		...
		String result = null;
		try {
			result = messageSource.getMessage(code, objects, locale);
