 ...
 * Reason: 基本数据类型转换(主要是byte和其它类型之间的互转.. <br/>
 * Date: 2018年7月9日 下午7:00:32 <br/>
 * 
 * @author sunlangping
 * @version
 * @see
...
public class ByteUtils {
	...
	public static int byte4ToIntAuto(byte[] arr) {
		int len = 4;
		if (arr.length < len) {
			byte[] b = new byte[len];
			System.arraycopy(arr, 0, b, len - arr.length, arr.length);
	...
	public static String splitBlank(String command) {
