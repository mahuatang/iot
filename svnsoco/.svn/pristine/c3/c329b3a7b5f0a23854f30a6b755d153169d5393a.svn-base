...
public class DeviceServiceTest extends BaseTest {
	...
	@Test
	public void testRemoveUserRunPointByUserId() throws Exception {
		Long userId = 13483l;
		deviceService.removeUserRunPointByUserId(userId);
	}

	@Test
	public void testQueryDeviceInfoByDeviceNo() throws Exception {
		String deviceNo = "865067021512622";
		System.out.println(deviceService.queryDeviceInfoByDeviceNo(deviceNo));
	}
